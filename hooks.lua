...
module:hook_post_require("lib/units/enemies/cop/copdamage", "units/enemies/copdamage")
...
module:hook_post_require("lib/managers/group_ai_states/groupaistatestreet", "managers/groupaistatestreet")
